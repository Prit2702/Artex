...
class EdgeDetectionViewer {
    ...
    private modes: string[] = ['Canny Edge', 'Sobel', 'Grayscale', 'Raw'];
    ...
    public displayFrame(base64Data: string): void {
        const img = new Image();
        img.onload = () => {
    ...
    public displayPixelData(pixelData: Uint8Array, width: number, height: number): void {
